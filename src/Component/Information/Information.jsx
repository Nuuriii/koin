...
function Information() {
   return (
      <>
         <div className='relative flex flex-col items-center justify-between px-20 py-10 mx-5 shadow-md bg-violet-400 md:mx-10 sm:gap-5 sm:py-3 sm:flex-row shadow-violet-300 rounded-xl bottom-9'>
